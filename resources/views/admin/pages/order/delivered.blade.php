@extends('admin.master.master',["sidebarLink"=>["main"=>'order',"active"=>'delivered']])
@section('title')
                        ...
                        <div class="col-md-12">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th  colspan="6">
                                            <form action="" style="display: flex" id="deliveredOrderSerachForm">
                                                <input type="text"  class="form-control" style="width: 80%" id="deliveredOrderSerachInput" placeholder="Search by  order id">
                                                <button class="btn btn-success form-control" style="width:20%" type="button" id="deliveredOrderSerachButton"><i class="fas fa-search"></i></button>
                                            </form>
                                        </th>
                                    </tr>
                                </thead>
                    ...
                    <ul class="pagination pagination-sm m-0 float-right">
                        ...
                        @for ($i = 1; $i <= $orders->lastPage(); $i++)
                            <li class="page-item"><a
                                    ...
                                    href="/admin/order/delivered-orders?page={{ $i }}">{{ $i }}</a></li>
                        @endfor
                        <li class="page-item"><a class="page-link"
