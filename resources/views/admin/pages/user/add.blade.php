@extends('admin.master.master',["sidebarLink"=>["main"=>'user',"active"=>'add']])
@section('title')
    Add User
@endsection
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text"
                                    ...
                                    id="fname" name="firstname" value="{{ old('firstname') }}">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text"
                                    ...
                                    id="lname" name="lastname" value="{{ old('lastname') }}">
                            </div>
                                ...
                                <div class="col-6">
                                    <select name="role_id" id="role" class="form-control text-capitalize">
                                        @foreach ($roles as $role)
                                            <option value="{{ $role->id }}" {{ $role->id == 5 ? 'selected' : '' }}>
                                                {{ $role->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
