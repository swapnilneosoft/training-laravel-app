                        ...
                        <div class="col-md-12">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th  colspan="6">
                                            <form action="" style="display: flex" id="pendingOrderSerachForm">
                                                <input type="text"  class="form-control" style="width: 80%" id="pendingOrderSerachInput" placeholder="Search by  order id">
                                                <button class="btn btn-success form-control" style="width:20%" type="button" id="pendingOrderSerachButton"><i class="fas fa-search"></i></button>
                                            </form>
                                        </th>
                                    </tr>
                                </thead>
