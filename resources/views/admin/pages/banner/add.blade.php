@extends('admin.master.master',["sidebarLink"=>["main"=>'banner',"active"=>'addBanner']])
@section('title')
    Add banner
@endsection
                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group text-center">
                            <img src="#" alt="" class="img-fluid" id="frameImg" width="50%">
                        </div>
                        <div class="form-group text-center">
                            <button class="btn btn-success" style="width: 70%">Add</button>
                        </div>
                    </form>
                </div>
            </div>
