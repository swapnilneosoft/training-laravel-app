...
Route::group([], function () {
    ...
    Route::get('/about-us', [CmsController::class, 'getAbout']);
    Route::get('/terms', [CmsController::class, 'getTerms']);
    Route::get('/privacy-policy', [CmsController::class, 'getPolicy']);
    Route::post('/subscribe/newsletter',[NewsletterController::class,'subcsribe']);
});
